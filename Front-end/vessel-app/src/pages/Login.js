    ...
    return (
        <div>
            <div className="container login-container">
                <div className="login-banner" style={{backgroundImage: "url(" + process.env.PUBLIC_URL + '/images/login-banner2.png' + ")"}}>
                ...
                <div className="login-form">
                    <div className="login-form-content">
                        ...
                        <p className="login-form-subtitle">Log in to your account to access variable x and variable y!</p>
                        <div className="login-form-divider" />
                        <form>
                            <div className="login-form-controls">
                                <div className="login-form-control-input-container">
                                    <input className="login-form-control-input" type="text" id="emailAddress"/>
                            ...
                            <div className="login-form-controls">
                                <div className="login-form-control-input-container">
                                    <input className="login-form-control-input" type="text" id="password" aria-labelledby="password"/>
                            ...
                            <div className="login-form-button">Log In</div>
                        </form>
