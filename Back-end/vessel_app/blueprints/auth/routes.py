...
from vessel_app.blueprints.auth.forms import  RegistrationForm, LoginForm, UpdateAccountForm
from vessel_app.models import User
from vessel_app.blueprints.auth import bp
...
def account():
    ...
    image_file = url_for('static', filename='profile_pics/' + current_user.image_file) # deprecated
